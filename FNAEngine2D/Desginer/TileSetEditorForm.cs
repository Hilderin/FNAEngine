...
namespace FNAEngine2D.Desginer
{
    ...
    {
        /// <summary>
        /// Current TileSetEditorForm
        /// </summary>
        public static TileSetEditorForm Current; 
        ...
        /// Constructor
        /// </summary>
        public TileSetEditorForm(TileSet tileSet)
        {
            InitializeComponent();

            Current = this;
            _gameObject = ContentDesigner.Current.CurrentGameObject;
        ...
        private void SetCurrentTile(int tileX, int tileY, Tile tile)
        {
            ...
            ContentDesigner.Current.SetDirty(true);
        ...
        private void LoadTileSet(string assetName)
        {
            try
            {
                ...
                else
                {
                    ...
                    string fullPath = GameHost.InternalGameHost.ContentManager.GetAssetFullPath(assetName, ContentManager.TEXTURES_EXTENSIONS);
