...
namespace FNAEngine2D
{
    public struct Vector2Int : IEquatable<Vector2Int>
    {
        ...
        private static Vector2Int zeroVector = new Vector2Int(0f, 0f);
        private static Vector2Int unitVector = new Vector2Int(1f, 1f);
        private static Vector2Int unitXVector = new Vector2Int(1f, 0f);
        private static Vector2Int unitYVector = new Vector2Int(0f, 1f);
        ...
        {
            this.X = GameMath.RoundInt(x);
            this.Y = GameMath.RoundInt(y);
        }
        ...
        {
            this.X = GameMath.RoundInt(value);
            this.Y = this.X;
        }
        ...
        /// <summary>
        /// Turns this <see cref="Vector2Int"/> to a unit vector with the same direction.
        /// </summary>
        public void Normalize()
        {
            float val = 1.0f / (float)Math.Sqrt((X * X) + (Y * Y));
            X = GameMath.RoundInt(X * val);
            Y = GameMath.RoundInt(Y * val);
        }
        ...
        public static Vector2Int Barycentric(
            Vector2Int value1,
            Vector2Int value2,
            Vector2Int value3,
            int amount1,
        ...
        public static void Barycentric(
            ...
            ref Vector2Int value3,
            int amount1,
            int amount2,
            out Vector2Int result
        )
        {
            result.X = GameMath.RoundInt(MathHelper.Barycentric(value1.X, value2.X, value3.X, amount1, amount2));
            result.Y = GameMath.RoundInt(MathHelper.Barycentric(value1.Y, value2.Y, value3.Y, amount1, amount2));
        }
        ...
        public static Vector2Int CatmullRom(
            Vector2Int value1,
            Vector2Int value2,
            Vector2Int value3,
            Vector2Int value4,
        ...
        public static void CatmullRom(
            ...
            ref Vector2Int value2,
            ref Vector2Int value3,
            ref Vector2Int value4,
            int amount,
            out Vector2Int result
        )
        {
            result.X = GameMath.RoundInt(MathHelper.CatmullRom(value1.X, value2.X, value3.X, value4.X, amount));
            result.Y = GameMath.RoundInt(MathHelper.CatmullRom(value1.Y, value2.Y, value3.Y, value4.Y, amount));
        }
        ...
        {
            result.X = GameMath.RoundInt(MathHelper.Clamp(value1.X, min.X, max.X));
            result.Y = GameMath.RoundInt(MathHelper.Clamp(value1.Y, min.Y, max.Y));
        }
        ...
        {
            float v1 = value1.X - value2.X, v2 = value1.Y - value2.Y;
            result = GameMath.RoundInt((v1 * v1) + (v2 * v2));
        }
        ...
        public static void Divide(ref Vector2Int value1, float divider, out Vector2Int result)
        {
            ...
            result.X = GameMath.RoundInt(value1.X * factor);
            result.Y = GameMath.RoundInt(value1.Y * factor);
        }
        ...
        {
            return ((float)value1.X * value2.X) + ((float)value1.Y * value2.Y);
        }
        ...
        {
            result = ((float)value1.X * value2.X) + ((float)value1.Y * value2.Y);
        }
        ...
        public static Vector2Int Hermite(
            Vector2Int value1,
            Vector2Int tangent1,
            Vector2Int value2,
            Vector2Int tangent2,
        ...
        public static void Hermite(
            ref Vector2Int value1,
            ref Vector2Int tangent1,
            ref Vector2Int value2,
            ref Vector2Int tangent2,
            int amount,
            out Vector2Int result
        )
        {
            result.X = GameMath.RoundInt(MathHelper.Hermite(value1.X, tangent1.X, value2.X, tangent2.X, amount));
            result.Y = GameMath.RoundInt(MathHelper.Hermite(value1.Y, tangent1.Y, value2.Y, tangent2.Y, amount));
        }
        ...
        {
            result.X = GameMath.RoundInt(MathHelper.Lerp(value1.X, value2.X, amount));
            result.Y = GameMath.RoundInt(MathHelper.Lerp(value1.Y, value2.Y, amount));
        }
        ...
        {
            value1.X = GameMath.RoundInt(value1.X * scaleFactor);
            value1.Y = GameMath.RoundInt(value1.Y * scaleFactor);
            return value1;
        }
        ...
        {
            result.X = GameMath.RoundInt(value1.X * scaleFactor);
            result.Y = GameMath.RoundInt(value1.Y * scaleFactor);
        }
        ...
        /// <summary>
        /// Creates a new <see cref="Vector2Int"/> that contains a normalized values from another vector.
        /// </summary>
        /// <param name="value">Source <see cref="Vector2Int"/>.</param>
        ...
        public static Vector2Int Normalize(Vector2Int value)
        {
            ...
            value.X = GameMath.RoundInt(value.X * val);
            value.Y = GameMath.RoundInt(value.Y * val);
            return value;
        }
        ...
        public static void Normalize(ref Vector2Int value, out Vector2Int result)
        {
            float val = 1.0f / (float)Math.Sqrt((value.X * value.X) + (value.Y * value.Y));
            result.X = GameMath.RoundInt(value.X * val);
            result.Y = GameMath.RoundInt(value.Y * val);
        }
        ...
        {
            Vector2Int result;
            float val = 2.0f * (((float)vector.X * normal.X) + ((float)vector.Y * normal.Y));
            result.X = GameMath.RoundInt(vector.X - (normal.X * val));
            result.Y = GameMath.RoundInt(vector.Y - (normal.Y * val));
            return result;
        }
        ...
        {
            result.X = GameMath.RoundInt(MathHelper.SmoothStep(value1.X, value2.X, amount));
            result.Y = GameMath.RoundInt(MathHelper.SmoothStep(value1.Y, value2.Y, amount));
        }
        ...
        {
            int x = GameMath.RoundInt((position.X * matrix.M11) + (position.Y * matrix.M21) + matrix.M41);
            int y = GameMath.RoundInt((position.X * matrix.M12) + (position.Y * matrix.M22) + matrix.M42);
            result.X = x;
            result.Y = y;
        }
        ...
        )
        {
            ...
            result.X = GameMath.RoundInt(value.X + x * rotation.W + (rotation.Y * z - rotation.Z * y));
            result.Y = GameMath.RoundInt(value.Y + y * rotation.W + (rotation.Z * x - rotation.X * z));
        }
        ...
        )
        {
            ...
            {
                Vector2Int position = sourceArray[sourceIndex + x];
                Vector2Int destination = destinationArray[destinationIndex + x];
                destination.X = GameMath.RoundInt((position.X * matrix.M11) + (position.Y * matrix.M21) + matrix.M41);
                destination.Y = GameMath.RoundInt((position.X * matrix.M12) + (position.Y * matrix.M22) + matrix.M42);
        ...
        )
        {
            ...
            {
                Vector2Int position = sourceArray[sourceIndex + i];
                Vector2Int v;
        ...
        public static void TransformNormal(
            ref Vector2Int normal,
            ref Matrix matrix,
            out Vector2Int result
        )
        {
            int x = GameMath.RoundInt((normal.X * matrix.M11) + (normal.Y * matrix.M21));
            int y = GameMath.RoundInt((normal.X * matrix.M12) + (normal.Y * matrix.M22));
            result.X = x;
            result.Y = y;
        }
        ...
        )
        {
            for (int i = 0; i < length; i += 1)
            {
                Vector2Int position = sourceArray[sourceIndex + i];
                Vector2Int result;
                result.X = GameMath.RoundInt((position.X * matrix.M11) + (position.Y * matrix.M21));
                result.Y = GameMath.RoundInt((position.X * matrix.M12) + (position.Y * matrix.M22));
        ...
        {
            value.X = GameMath.RoundInt(value.X * scaleFactor);
            value.Y = GameMath.RoundInt(value.Y * scaleFactor);
            return value;
        }
        ...
        {
            float factor = 1 / divider;
            value1.X = GameMath.RoundInt(value1.X * factor);
            value1.Y = GameMath.RoundInt(value1.Y * factor);
            return value1;
        }
