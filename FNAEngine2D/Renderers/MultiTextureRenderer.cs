...
namespace FNAEngine2D.Renderers
{
    ...
    public class MultiTextureRenderer<T> : Component where T : System.Enum
    {
        ...
        /// Constructor
        /// </summary>
        public MultiTextureRenderer(string textureFolder)
        {
        ...
        private void RecalculateScale()
        {
            foreach (TextureInfo textureInfo in _textures.Values)
            {
                if (textureInfo.Texture.Data.Width == 0 || textureInfo.Texture.Data.Height == 0)
                    ...
                    textureInfo.Scale = new Vector2(this.GameObject.Width / textureInfo.Texture.Data.Width, this.GameObject.Height / textureInfo.Texture.Data.Height);
            }
        }
